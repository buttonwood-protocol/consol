...
contract Integration_15_HalfConvertedTest is IntegrationBaseTest {
  ...
  function run() public virtual override {
    ...
    // Lender mints $50k worth of Consol via USDT
    uint256 usdxAmount = consol.convertUnderlying(address(usdx), 50_000e18);
    ...
    // Lender submits a withdrawal request to the conversion queue with 50k consol
    vm.startPrank(lender);
