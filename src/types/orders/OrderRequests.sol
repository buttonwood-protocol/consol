 ...
 * @param collateralAmount The amount of collateral to borrow against. This will be escrowed in the Consol contract.
 * @param totalPeriods The total number of periods that the mortgage will last
 * @param originationPool The address of the origination pool to use
